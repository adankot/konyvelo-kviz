...
function Rankings({ showHomePage, rankingType }: any) {
  ...
  return (<div>
    ...
    <div className={'rankings-menu'}>
      <div className={'rankings-menu-item'} onClick={() => setType('quiz-2')}>Igaz/Hamis</div>|
      <div className={'rankings-menu-item'} onClick={() => setType('quiz-3')}>Kvíz 3</div>|
      <div className={'rankings-menu-item'} onClick={() => setType('quiz-4')}>Kvíz 4</div>|
      <div className={'rankings-menu-item'} onClick={() => setType('diff')}>Különbség kereső</div>|
      <div className={'rankings-menu-item'} onClick={() => setType('puzzle')}>Puzzle</div>
    </div>
